...
var Select = (function (Interaction) {
   ...
   * @private
   */
  Select.prototype.giveSelectedStyle_ = function giveSelectedStyle_ (feature) {
   ...
   * @private
   */
  Select.prototype.removeSelectedStyle_ = function removeSelectedStyle_ (feature) {
    var key = getUid(feature);
   ...
   * @api stable
   */
  Select.prototype.select = function select (selected) {
   ...
   * @api stable
   */
  Select.prototype.deselect = function deselect (deselected) {
    var this$1 = this;

    if (deselected.length > 0) {
      for (var i = deselected.length - 1; i >= 0; --i) {
        this$1.features_.remove(deselected[i]);
      }
      this.dispatchEvent(
        new SelectEvent(SelectEventType.SELECT,
          [], deselected, null));
